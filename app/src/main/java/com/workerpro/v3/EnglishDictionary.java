...
public class EnglishDictionary {
    ...
    public static List<Word> getWords() {
        ...
        words.add(new Word("Bore", "Отверстие / расточка", "Deşik / yonma"));
        words.add(new Word("Boring", "Растачивание", "Yonma"));
        ...
        words.add(new Word("Deburring Tool", "Инструмент для удаления заусенцев", "Qabarıq kənar təmizləyici alət"));
        ...
        words.add(new Word("Die", "Штамп / матрица", "Ştamplama aləti"));
        ...
        words.add(new Word("Diamond Tool", "Алмазный инструмент", "Almaz alət"));
        words.add(new Word("Drill", "Сверло / сверлить", "Burğu"));
        ...
        words.add(new Word("File", "Напильник", "Egov"));
        ...
        words.add(new Word("Guard", "Защитное ограждение", "Qoruyucu çəpər"));
        ...
        words.add(new Word("Knurling", "Накатка", "Dişli naxışlama"));
        ...
        words.add(new Word("Rejected Part", "Бракованная деталь", "Qüsurlu detal"));
        ...
        words.add(new Word("Unclamping", "Разжимание", "Sıxacın açılması"));
